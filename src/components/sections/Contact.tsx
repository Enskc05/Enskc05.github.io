...
export function Contact() {
  const { t } = useLanguage()
  return (
    <section id="contact" className="min-h-screen bg-slate-950 py-12 sm:py-16 md:py-20 w-full" aria-label="İletişim bölümü">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mt-20 text-center border-t border-slate-800 pt-8 px-4 sm:px-6 lg:px-8"
      >
